...
Твой ответ ДОЛЖЕН иметь ТОЧНО такую структуру (я уже написал { за тебя, продолжай):
...
ВАЖНО: Вложенность обязательна! Поля strengths, issues, tasks должны быть ВНУТРИ объекта "analysis", не на верхнем уровне!

Продолжай JSON с "needs_clarification":`;
}
