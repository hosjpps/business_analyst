...
ПОМНИ: Твой ответ будет автоматически парситься как JSON. Если ты добавишь любой текст кроме JSON, приложение сломается. Верни ТОЛЬКО JSON объект, начиная с { и заканчивая }.`;
}
