...
- **technical** - Техническое: код, инфраструктура, масштабируемость
- **product** - Продукт: фичи, UX, дизайн
- **marketing** - Маркетинг: SEO, контент, соцсети
- **business** - Бизнес: стратегия, партнёрства, legal
- **monetization** - Монетизация: платежи, подписки, pricing
- **growth** - Рост: аналитика, воронки, удержание
- **security** - Безопасность: защита данных, авторизация, уязвимости
