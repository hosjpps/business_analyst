...
const ANALYSIS_TERMS: Record<string, TooltipTerm> = {
  ...
  alignment_score: {
    term: 'Соответствие бизнес-целям',
    simple: 'Оценка, насколько продукт соответствует целям бизнеса (0-100).',
    example: '75 баллов = хорошо, но есть что улучшить',
    whyMatters: 'Показывает, решает ли код реальные бизнес-задачи.',
  },
  market_readiness: {
    term: 'Готовность к рынку',
    simple: 'Насколько продукт готов к первым продажам и работе с клиентами.',
    example: 'Есть оплата, аналитика, маркетинг = высокая готовность',
    whyMatters: 'Без готовности к рынку нет смысла привлекать клиентов.',
  },
  technical_quality: {
    term: 'Техническое качество',
    simple: 'Качество кода, тестов, документации и инфраструктуры.',
    example: 'Есть CI/CD, тесты, хорошая архитектура = высокое качество',
    whyMatters: 'Низкое качество = баги, медленная разработка, технический долг.',
  },
  security_score: {
    term: 'Безопасность',
    simple: 'Насколько защищены данные пользователей и бизнеса.',
    example: 'Есть аутентификация, шифрование, нет уязвимостей = высокий скор',
    whyMatters: 'Утечка данных = потеря доверия, штрафы, закрытие бизнеса.',
  },
  verdict: {
    term: 'Вердикт',
